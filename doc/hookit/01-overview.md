...
3. Lire la description et les cas d'usage d'un hook et selectionner les hooks qu'il veut mettre en place dans son projet
4. Cliquer "Hookit"
5. Le prompt est copié dans son clipboard manager, on le composeille de le coller dans claude code
